...
// Using the model set in the route, which we updated to 1.5-flash. 
// If the user insisted on 2.5, we can try that here to see if it works.
...
const data = JSON.stringify({
    contents: [{
        parts: [{ text: "Hello, explain how a library works in one sentence." }]
    }]
});
